...
/// Where a value sits relative to "this is fine" and "this needs attention".
/// Drives colour in threshold mode and the severity of notifications.
public enum MetricSeverity: Int, Sendable, Equatable, Comparable {
    case normal = 0, elevated = 1, high = 2, critical = 3

    public static func < (a: Self, b: Self) -> Bool { a.rawValue < b.rawValue }

    /// Standard ramp for 0...1 utilisation metrics.
    public static func forUtilization(_ fraction: Double) -> MetricSeverity {
        switch fraction {
    ...
    /// Inverted ramp for "remaining" metrics like free disk or battery charge.
    public static func forRemaining(_ fraction: Double) -> MetricSeverity {
        switch fraction {
        case ..<0.05: return .critical
        case ..<0.10: return .high
        case ..<0.20: return .elevated
        default: return .normal
        }
    }

    public static func forTemperature(_ celsius: Double) -> MetricSeverity {
        switch celsius {
